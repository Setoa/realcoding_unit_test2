...
public class MockServiceTest {
    ...
    // 1. when, thenReturn을 사용하여 어떠한 챔피언 이을 입력해도 베인을 리턴하도록 테스트하세요
    @Test
    ...
    public void confirmArraySizeCheck(){
        ...
        System.out.println(mockChampions.size());
    ...
    @Test
    public void shouldAtMostThreeTimesInvocationForGetChampionName(){
        Champion champion = mock(Champion.class);
        champion.setName("시비르");
        champion.setPosition("바텀");
        champion.setHasSkinCount(6);
    ...
    public void testConfirmCountWhenGetChampionList(){
        ...
        champions.add(new Champion("루시안","바텀",3));
    ...
    public void testInvocationCountWhenGetChampionList(){
        ...
        champions.add(new Champion("애쉬","바텀",4));
